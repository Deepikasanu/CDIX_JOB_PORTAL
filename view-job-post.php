      ...
      <div class="container">
        <div class="row">          
          <div class="col-md-9 bg-white padding-2">
            ...
            <hr>
            <div>
              <p><span class="margin-right-10"><i class="fa fa-location-arrow text-green"></i> <?php echo $row['city']; ?></span> <i class="fa fa-calendar text-green">Job Start Date</i> <?php echo date("d-M-Y", strtotime($row['createdat'])); ?> </span> <i class="fa fa-calendar text-green">    Job Expiry Date   </i> <?php echo date("d-M-Y", strtotime($row['qualification'])); ?>                   </p>              
            </div>
            <div>
